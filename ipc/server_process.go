...
func (s *Server) handleGetProcDetail(conn net.Conn, rawPayload json.RawMessage) {
	...
	resp := GetProcDetailResponse{
		...
		CumInputTokens:              snap.CumInputTokens,
		CumCachedInputTokens:        snap.CumCachedInputTokens,
		CumCacheCreationInputTokens: snap.CumCacheCreationInputTokens,
		CumOutputTokens:             snap.CumOutputTokens,
	}
